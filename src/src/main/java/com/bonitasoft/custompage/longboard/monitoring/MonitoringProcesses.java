...
public class MonitoringProcesses {
    ...
    public static class ProcessItem
    {
        ...
        public String getKey(Calendar c)
        {
            return c.get(Calendar.YEAR) + "/" + c.get(Calendar.MONTH) + "/" + c.get(Calendar.DAY_OF_MONTH) + " " + c.get(Calendar.HOUR_OF_DAY) + ":"
                    + (int) (c.get(Calendar.MINUTE) / 10) + "0";
        }
        ...
        public HashMap<String, Object> getJson()
        {
            ...
            ChartParameters chartParameters = new ChartParameters("create case", "AreaChart", "Open", "string", "open", "Case created", "number",
                    "Case created");
    ...
    public static HashMap<String, Object> monitorProcesses(MonitorProcessInput monitorProcessInput, ProcessAPI processAPI) {
        ...
        logger.info("Input " + monitorProcessInput.defaultWarningNearbyTasks + " " + monitorProcessInput.defaultWarningNbOverflowTasks + " "
                + monitorProcessInput.defaultWarningNbTasks);
        Calendar c = Calendar.getInstance();
        ...
        try {
            ...
            if (monitorProcessInput.studypastactivities)
            {
                ...
                do
                {
                    ...
                    logger.info("################### NbActivity beetween [" + dateReferenceFrom + "," + dateReferenceTo + "] - (" + index + "-10000) : "
                            + searchActivityArchived.getCount()
