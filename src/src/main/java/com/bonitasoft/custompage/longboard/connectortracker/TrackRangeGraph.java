...
public class TrackRangeGraph {
     ...
     * @return
     */
    public static String getGraphRange(final String title, final List<StatsTracker> listRange) {
        ...
        {
            resultValue += "{\"c\":[{\"v\":\"" + listRange.get(i).titleGraph + "\"},{\"v\": " + listRange.get(i).getAvgDuration() + "} ]},";
        ...
        final String resultLabel = "{ \"type\": \"string\", \"id\": \"whattime\", \"label\":\"whattime\" },"
                + "{ \"type\": \"number\", \"id\": \"value\", \"label\":\"Duration\" }";
    ...
    public static String getGraphRepartition(final String title, final HashMap<String, StatsTracker> listRange) {
         ...
         */
        String resultValue = "";
        // logger.info("Graph["+title+"] ListRange.size() ["+listRange.size()+"] value="+listRange);
        ...
        final String resultLabel = "{ \"type\": \"string\", \"id\": \"connector\", \"label\":\"connector\" },"
                + "{ \"type\": \"number\", \"id\": \"value\", \"label\":\"Duration\" }";
