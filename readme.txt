...
- nb de workers
- nb de thread pour les connecteurs
- data source connection pool size

Outil d'analyse d'un groupe de case

CASE HISTORY
- Multi instance Human task
- connector synthesis

MONITOR
- graph tache par tache de l'historing d'INPUT, de l'historing d'OUTPUT
